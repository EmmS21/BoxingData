...
export declare enum BoxrecStatus {
    active = "a",
    all = ""
}
...
export declare enum WeightDivisionCapitalized {
...
export declare enum BoxrecFighterRole {
    proBoxer = "proboxer",
...
export declare enum BoxrecFighterOption {
...
export declare enum BoxrecRole {
    proBoxer = "proboxer",
    amateurBoxer = "amateurboxer",
    amateurKickBoxer = "amateurkickboxer",
    kickboxer = "kickboxer",
    proKickBoxer = "kickboxer",
    muayThaiBoxer = "muaythaiboxer",
    proMuayThaiBoxer = "muaythaiboxer",
    amateurMuayThaiBoxer = "amateurmuaythaiboxer",
    bareKnuckleBoxer = "bareknuckleboxer",
    doctor = "doctor",
    inspector = "inspector",
...
export declare enum WeightDivision {
    heavyweight = "heavyweight",
    cruiserweight = "cruiserweight",
    lightHeavyweight = "light heavyweight",
    superMiddleweight = "super middleweight",
